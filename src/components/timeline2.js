...
function Timeline2(){
    ...
    <main>
        ...
        <p class="newtime"><p class="roadhead">50% SALE<br></br>
NFT Marketplace <br></br>
(partnership)</p><br></br>Our holders never pay
the 2% transaction fee.
NEVER!!</p>
<p class="newtime"><p class="roadhead">75% SALE</p><br></br>Partnering with Ram
Mandir Trust (Ayodhya)
and donate 20%<br></br> of our
